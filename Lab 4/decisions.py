...
class decision_maker(Node):
    ...
    def __init__(self, publisher_msg, publishing_topic, qos_publisher, rate=10, motion_type=POINT_PLANNER):
        ...
        # PART 5 your localization type (change this to 1 if our stuff works)
        self.localizer=localization(0)
        ...
        if motion_type==POINT_PLANNER:
            ...
            self.controller=trajectoryController(klp=0.2, klv=0.5, kap=0.8, kav=0.6) #(klp=1.1, klv=0.005, kap=1.1, kav=0.005) #(klp=0.2, klv=0.5, kap=0.8, kav=0.6)      
