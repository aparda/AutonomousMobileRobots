...
class localization(Node):
    ...
    def __init__(self, localizationType=rawSensor):
        ...
        odom_qos= QoSProfile(reliability=2, history=1, durability=2, depth=10)
        ...
        if localizationType == rawSensor:
            ...
            self.odom_subscriber = self.create_subscription(odom, "odom", self.odom_callback, qos_profile=odom_qos)
        else:
